...
# 需要修改，配置文件位置
CONFIG_CFG = '/etc/xserver/server.properties'
...
if __name__ == '__main__':
    ...
    print cfg_get('xserver.http.port')
    print cfg_get('xserver.mysql.host')
    print cfg_get('video.serverHost')
    print cfg_get('xmodule.fts.url')
    print cfg_get(" xmodule.fscore.stor.type")
    print cfg_get('xmodule.fscore.reifs.host')
    print cfg_get("xmodule.webdoc.api")
